...
- During Ancient Library owner playtesting, stage exactly one Library in another eligible non-entrance, non-exit, non-combat room using the same off-route preference as the other temporary events. This does not settle final event frequency or distribution.
...
- During Chained Prisoner owner playtesting, stage exactly one Prisoner in a fourth eligible room using the same off-route preference as the other temporary events. This does not settle final event frequency or distribution. The Question success, truthful-direction clue, initial Leave preservation, and resolved-room no-retrigger flows passed owner Board Lab review on 2026-09-13. The Free injury/death branches remain automated-test verified rather than owner-playtested.
...
- During Room of Blades owner playtesting, also stage exactly one Trap Room in a different eligible room using the same off-route preference. This remains temporary test placement and does not settle final event frequency or distribution.
...
- During Strange Hole owner playtesting, stage exactly one Hole in a fifth eligible room using the same off-route preference as the other temporary events. This does not settle final event frequency or distribution. The Look success, truthful-direction clue, board presentation, and pacing passed owner Board Lab review on 2026-09-13. The Reach/cache/injury branches remain automated-test verified rather than owner-playtested.
